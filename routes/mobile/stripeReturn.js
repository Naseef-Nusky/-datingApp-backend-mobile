...
/**
 * Stripe Checkout success/cancel page for the native app (in-app Safari).
 * The app polls for payment completion and closes the browser automatically.
 */
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    p { font-size: 0.95rem; line-height: 1.5; color: #6b7280; }
  </style>
</head>
<body>
  <div class="card">
